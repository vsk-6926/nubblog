...
const Write = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (file) {
      ...
      try {
        await axios.post("https://nubblog.herokuapp.com/upload", data);
      } catch (err) {}
    }
    try {
      const res = axios.post("https://nubblog.herokuapp.com/posts", newPost);
      window.location.replace("https://nubblog.herokuapp.com/post/" + res.data._id);
      setSuccess(true);
    } catch (err) {}
  };
